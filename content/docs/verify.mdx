---
title: "Verify an encryption proof"
icon: BadgeCheck
...
<Cards>
  ...
  <Card title="TDX attestation" href="/docs/how-it-works/attestation" description="How the note is produced, both report_data formulas, and what a verifier can and cannot check today." />
  <Card title="On-chain encryption proof" href="/docs/how-it-works/proof" description="The receipt format, the signed byte layout, and who signs and pays." />
  <Card title="Proof lookups" href="/docs/how-it-works/proof" description="The four endpoints that read receipts." />
</Cards>
