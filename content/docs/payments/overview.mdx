...
Configured ratios: not published. `GET /payments/buyback/log` returns the recent buyback worker ticks, including skipped ones. See [/docs/payments/tokenomics](/docs/payments/tokenomics) for the token supply schedule and vesting details.
