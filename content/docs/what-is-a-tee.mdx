...
The page [What is private here](/docs/what-is-private) has the full table of who can see what.
...
<Cards>
  <Card title="Check a reply yourself" href="/docs/verify-a-reply" description="Paste a lock link and see the check pass. Then compare the live key with the signed note." />
  <Card title="Attestation, in depth" href="/docs/under-the-hood/attestation" description="The two note formats, how to verify Intel's signature chain, and what is still missing." />
</Cards>
