...
| `402` Payment Required | Your free messages and plan calls are used up and the account has no USDC credit, or the route is x402-paywalled and no payment was attached. | Pick a plan at [solrouter.com](https://solrouter.com) (see [Pricing](/docs/use/pricing)), or pay per call with x402 and retry. |
