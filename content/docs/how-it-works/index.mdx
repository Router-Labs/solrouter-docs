...
- Chat app (solrouter.com/chat): holds your session. Today it sends prompts to the backend in plaintext; sealing every web chat prompt is Soon. Agent mode and its Notion and GitHub connectors run on the backend.
