...
A plan covers your calls. Without one, each sealed call costs \$0.02 from your USDC balance. The 5 free messages come with a web chat sign-in and do not apply to calls made with an API key. See [Pricing](/docs/use/pricing).
...
| ------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------- |
| **API key**        | `Authorization: Bearer sk_solrouter_...`. Sealed calls draw from your plan, then from USDC balance at \$0.02; priced agent routes debit their price from the balance                                                   | Most applications and development workflows |
