...
* **API key.** Include `Authorization: Bearer sk_solrouter_...` in every request. Usage bills against the account behind the key. Best when your agent is long-lived and you have already funded an account.
