...
<Steps>
  <Step>
    ...
    Go to [solrouter.com/sdk](https://solrouter.com/sdk), sign in with an email address or a Solana wallet, and generate an API key. Your first 5 messages are free. After that, pick a plan: Pro \$9 for 2,000 calls, Builder \$49 for 12,500, or Scale \$99 for 30,000, each per 30 days. See [Pricing](/docs/use/pricing).
  ...
  <Step>
    ...
    Calls draw from your plan first. If the account also holds USDC credit, you can read it from the SDK:
