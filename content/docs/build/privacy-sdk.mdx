...
Calls draw from your plan first. If the account also holds USDC credit, read it here.
...
Sign in at [solrouter.com/sdk](https://solrouter.com/sdk) with an email address or a Solana wallet, with no KYC, and generate an API key. Your first 5 messages are free. After that a plan covers your calls: Pro \$9 for 2,000, Builder \$49 for 12,500, or Scale \$99 for 30,000, each per 30 days in USDC. See [Pricing](/docs/use/pricing).
