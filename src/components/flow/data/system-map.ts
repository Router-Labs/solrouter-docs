...
export const systemMapNodes: BoxNode[] = [
  boxNode('chat', 0, 0, {
    icon: 'MessageSquare',
    title: 'Chat app',
    sub: 'solrouter.com; Maximum Privacy Mode encrypts in the browser',
    accent: true,
    detail: {
      ...
      href: '/docs/products/chat-app',
    },
  }),
  boxNode('sdk', 0, 110, {
    icon: 'Code',
    title: '@solrouter/sdk',
    sub: 'Your process, encrypts before send',
    accent: true,
    detail: {
      ...
      href: '/docs/products/privacy-sdk',
    },
  }),
  boxNode('mcp', 0, 220, {
    icon: 'Plug',
  ...
  boxNode('rest', 0, 330, {
    ...
    detail: {
      ...
      href: '/docs/api-reference/inference',
    },
  }),
  boxNode('backend', 330, 165, {
    icon: 'Server',
    title: 'Solrouter backend',
    sub: 'Render: blind relay, keys, billing',
    detail: {
      ...
      href: '/docs/under-the-hood/request-flow',
    },
  }),
  boxNode('cvm', 660, 40, {
    icon: 'ShieldCheck',
    ...
    detail: {
      ...
      href: '/docs/under-the-hood/attestation',
    },
  }),
  boxNode('nosana', 990, 40, {
    ...
    detail: {
      ...
      href: '/docs/under-the-hood/models',
    },
  }),
  boxNode('solana', 660, 290, {
    icon: 'Landmark',
    title: 'Solana',
    sub: `program ${PROGRAM_ID}, Light compressed receipts, Photon`,
    detail: {
      holds: `One Light compressed receipt per inference under program ${PROGRAM_ID}, read through Photon. Cluster: mainnet by the explorer link and code comments (be:services/lightAttestation.js:81-82); not re-verified with getAccountInfo.`,
      sees: 'sha256 of the ciphertext, model, provider, and the enclave signature. No plaintext. Cluster: mainnet by the explorer link and code comments (be:services/lightAttestation.js:81-82); not re-verified with getAccountInfo.',
      status: 'Live',
      source: 'be:services/lightAttestation.js:81-82,359-363; be:routes/verifyAttestation.js:7-10',
      href: '/docs/under-the-hood/encryption-proof',
    },
  }),
  boxNode('umbra', 990, 290, {
    ...
    detail: {
      ...
      href: '/docs/under-the-hood/private-swaps',
    },
  }),
  boxNode('facilitator', 330, 400, {
    icon: 'Coins',
    title: 'Coinbase x402 facilitator',
    sub: 'advertised by the live manifest; which facilitator settles is not determined',
    detail: {
